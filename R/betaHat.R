...
#             contains integer patient IDs, the second column contains the     #
#             time of measurement, and the remainin columns contain the values #
#             of the covariates.                                               #
#                                                                              #
...
#                                                                              #
# tt        : If provided, a vector of times at which to evaluate the kernel   #
#                                                                              #
#                                                                              #
...
betaHat <- function(data.y, 
  ...
  #--------------------------------------------------------------------------#
  # Determine the number of covariates & initialize parameter estimates      #
  # Note that an intercept term is assumed here.                             #
  #--------------------------------------------------------------------------#
  nCov <- ncol(data.x) - 2L
